  ...
  return (
    <div className="flex flex-col p-4">
      <div className="flex justify-between items-center mb-8">
        ...
        <LogoutLink className='block rounded-lg bg-indigo-700 border border-indigo-400 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-indigo-600 focus:outline-none focus:ring'>
          Logout
        </LogoutLink>
      </div>
